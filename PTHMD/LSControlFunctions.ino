...
void LS1ON()
{
	...
	digitalWrite(S1_PIN, 0);				// Set the S1 control pin LOW to latch S1 to ON position
...
void LS1OFF()
{
	...
	digitalWrite(S1_PIN, 1);				// Set the S1 control pin HIGH to latch S1 to OFF position
...
void LS2ON()
{
	...
	digitalWrite(S2_PIN, 0);				// Set the S2 control pin LOW to latch S2 to ON position
...
void LS2OFF()
{
	...
	digitalWrite(S2_PIN, 1);				// Set the S2 control pin HIGH to latch S2 to OFF position
